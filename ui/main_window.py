...
from core.resource import MIN_MAINWINDOW_HEIGHT, MIN_MAINWINDOW_WIDTH, set_window_icon
...
class Container(QWidget):
    ...
    def set_container_widgets(self, widgets: list[QWidget]) -> None:
        ...
        for w in widgets:
            ...
            # MainContent nên chiếm phần còn lại
            self._layout.setStretchFactor(w, 1 if isinstance(w, MainContent) else 0)
