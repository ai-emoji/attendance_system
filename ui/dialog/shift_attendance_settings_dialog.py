...
from core.resource import CONTENT_FONT, FONT_WEIGHT_NORMAL, FONT_WEIGHT_SEMIBOLD, UI_FONT
from core.ui_settings import get_shift_attendance_table_ui, update_shift_attendance_table_ui
...
class ShiftAttendanceSettingsDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        def _refresh_column_defaults() -> None:
            ...
            self.cbo_visible.setCurrentIndex(self.cbo_visible.findData("show" if vis else "hide"))
            ...
            if key in (self._ui.column_bold or {}):
                ...
                self.cbo_column_weight.setCurrentIndex(self.cbo_column_weight.findData("inherit"))

        self.cbo_column.currentIndexChanged.connect(lambda _i: _refresh_column_defaults())
