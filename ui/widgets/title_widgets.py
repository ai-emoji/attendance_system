...
class MainContent(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.table.setHorizontalHeaderLabels(["ID", "STT", "Tên Chức Danh"])
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.Fixed)  # STT
        header.setSectionResizeMode(
            2, QHeaderView.ResizeMode.Stretch
        )  # Chức danh chiếm phần còn lại
        self.table.setColumnWidth(1, 60)  # STT = 60
    ...
    def _ensure_rows_fit_viewport(self) -> None:
        ...
        for row in range(current, desired):
    ...
    def _init_row_items(self, row: int) -> None:
        bold_font = QFont(UI_FONT, CONTENT_FONT)
