...
class MainLeft(QWidget):
    ...
    def set_schedules(self, rows: list[tuple[int, str]]) -> None:
        ...
        for r, (schedule_id, name) in enumerate(rows):
...
class MainRight(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # Icons
        self.btn_arrange.setIcon(QIcon(resource_path("assets/images/arrange_schedule.svg")))
        ...
        self.label_total.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight)
        ...
        self.chk_holiday_as_work = _mk_cb("Ngày Lễ được tính 1 công (một ngày làm việc cho trường hợp không đi làm)")
...
class ArrangeScheduleView(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.title = TitleBar1("Sắp xếp ca theo lịch trình", None, self)
